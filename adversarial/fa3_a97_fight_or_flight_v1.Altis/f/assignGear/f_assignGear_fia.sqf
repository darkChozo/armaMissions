...
_rifle = ["srifle_DMR_03_multicam_F","srifle_DMR_03_woodland_F"]; // Slight randomization, biased towards TRG
_riflemag = "20Rnd_762x51_Mag";
_riflemag_tr = "20Rnd_762x51_Mag";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["srifle_DMR_03_multicam_F","srifle_DMR_03_woodland_F"]; // Slight randomization, biased towards TRG
...
// Spec Op (CTRG)
_sfuniform = ["U_I_G_resistanceLeader_F"];
_sfhelmet = [];
_sfRig = _mediumRig;
