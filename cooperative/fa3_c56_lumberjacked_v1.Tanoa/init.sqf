...
if (isServer) then {
	...
	_transition setOvercast  1;
	_transition setRain 1;
	_transition setRainbow 0;
	_transition setWindStr  .6;
	_transition setWindForce .6;
	_transition setWaves 1;
	_transition setLightnings 1;
	_transition setFog .3;
};
