...
// Markers seen by players in BLUFOR-FIA slots.
	...
	case "blu_g_f":
	{
		...
		["GrpFIA_IFV2",  7, "TECH2", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpFIA_IFV3",  7, "TECH3", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpFIA_IFV4",  7, "TECH4", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpFIA_IFV5",  7, "TECH5", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpFIA_IFV6",  7, "TECH6", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpFIA_IFV7",  7, "TECH7", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpFIA_IFV8",  7, "TECH8", "ColorRed"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in OPFOR-FIA slots.
	...
	case "opf_g_f":
	{
		...
		["GrpOFIA_IFV2",  7, "TECH2", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpOFIA_IFV3",  7, "TECH3", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpOFIA_IFV4",  7, "TECH4", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpOFIA_IFV5",  7, "TECH5", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpOFIA_IFV6",  7, "TECH6", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpOFIA_IFV7",  7, "TECH7", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpOFIA_IFV8",  7, "TECH8", "ColorRed"] spawn f_fnc_localGroupMarker;
