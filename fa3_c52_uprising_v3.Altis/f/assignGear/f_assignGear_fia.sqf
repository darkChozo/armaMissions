...
// fancy guns
_zubr = "hgun_Pistol_heavy_02_F";
_zubrmag = "6Rnd_45ACP_Cylinder";
_spistol = "hgun_Pistol_Signal_F";
_spistolmag = "6Rnd_RedSignal_F";
_ninemil = "hgun_Rook40_F";
_ninemil2 = "hgun_P07_F";
_ninemilmag = "16Rnd_9x21_Mag";
_fortyfive = "hgun_Pistol_heavy_01_MRD_F";
_fortyfivemag = "11Rnd_45ACP_Mag";
...
// LOADOUT: COMMANDER
	case "co":
	{
		_unit addmagazines [_zubrmag,3];
		_unit addweapon (_zubr);
...
// LOADOUT: ASSISTANT AUTOMATIC RIFLEMAN
	case "aar":
	{
        _unit addMagazine ["20Rnd_762x51_Mag", 1];
...
// LOADOUT: MEDIUM MG GUNNER
	case "mmgg":
	{
		_unit addmagazines [_fortyfivemag,4];
		_unit addweapon _fortyfive;
	};

// LOADOUT: MEDIUM MG ASSISTANT GUNNER
	case "mmgag":
	{
		_unit addmagazines [_ninemilmag,3];
		_unit addweapon _ninemil2;
		_unit addWeapon "Binocular";
	};
...
// CARGO: IFV - room for 10 weapons and 100 cargo items
	case "v_ifv":
	{
		...
		_unit addBackpackCargoGlobal [_bagsmall, 2];
		_unit addWeaponCargoGlobal ["Rangefinder",1];
	};

// CRATE: weapons for 1 ft
	case "crate_ft":
{
		clearWeaponCargoGlobal _unit;
		clearMagazineCargoGlobal _unit;
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addWeaponCargoGlobal [(_rifle call BIS_fnc_selectRandom), 1 + floor random 3];
		_unit addWeaponCargoGlobal [(_carbine call BIS_fnc_selectRandom), 1 + floor random 3];
		_unit addWeaponCargoGlobal [(_glrifle call BIS_fnc_selectRandom), 1 + floor random 3];
		_unit addWeaponCargoGlobal [_AR, 1 + floor random 3];
		_unit addWeaponCargoGlobal [_RAT, 1];

		_unit addMagazineCargoGlobal [_riflemag, 10 + floor random 11];
		_unit addMagazineCargoGlobal [_riflemag_tr, 5 + floor random 8];
		_unit addMagazineCargoGlobal [_carbinemag, 4 + floor random 8];
		_unit addMagazineCargoGlobal [_carbinemag_tr, 2 + floor random 8];
		_unit addMagazineCargoGlobal [_ARmag, 2 + floor random 5];
		_unit addMagazineCargoGlobal [_ARmag_tr, 2 + floor random 5];
		_unit addMagazineCargoGlobal [_glmag, floor random 8];
		_unit addMagazineCargoGlobal [_glsmokewhite, floor random 8];
		_unit addMagazineCargoGlobal [_ratmag, floor random 3];
		_unit addMagazineCargoGlobal [_grenade, 5 + floor random 11];
		_unit addMagazineCargoGlobal [_mgrenade, 3 + floor random 10];
		_unit addMagazineCargoGlobal [_smokegrenade, 10 + floor random 20];
		_unit addMagazineCargoGlobal [_smokegrenadegreen, floor random 10];

		_unit addItemCargoGlobal [_medkit, 1];
		_unit addBackpackCargoGlobal [_bagsmall, 7];
		_unit addItemCargoGlobal ["ItemGPS",7];
		_unit addItemCargoGlobal [_nvg,7];
		_unit addItemCargoGlobal [_firstaid, 17 + floor random 11];
};

// CRATE: weapons for 1 squad
	case "crate_ammo":
{
		clearWeaponCargoGlobal _unit;
		clearMagazineCargoGlobal _unit;
		...
		_unit addMagazineCargoGlobal [_mgrenade, 5];
		_unit addMagazineCargoGlobal [_smokegrenade, 20];
		_unit addMagazineCargoGlobal [_smokegrenadegreen, 4];
		_unit addItemCargoGlobal [_firstaid, 25];
		_unit addItemCargoGlobal [_nvg,13];
};

// CRATE: weapons, ammo for mmg team
	case "crate_mmg":
{
		clearWeaponCargoGlobal _unit;
		clearMagazineCargoGlobal _unit;
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addWeaponCargoGlobal [_MMG, 1];
...
// CRATE: weapons, ammo for co team
case "crate_co":
{
		clearWeaponCargoGlobal _unit;
		clearMagazineCargoGlobal _unit;
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addWeaponCargoGlobal [(_carbine call BIS_fnc_selectRandom), 1];
		_unit addMagazineCargoGlobal [_carbinemag, 8];
		_unit addMagazineCargoGlobal [_smokegrenade,8];
		_unit addItemCargoGlobal [_medkit, 1];

		//co
		_unit addWeaponCargoGlobal [(_glrifle call BIS_fnc_selectRandom),1];					//_COrifle
		...
		_unit addMagazineCargoGlobal [_glflaregreen,6];
		_unit addMagazineCargoGlobal [_grenade,1];		// Do not use with mgrenades
		//_unit addmagazines [_mgrenade,1];		// Do not use with grenades
		_unit addMagazineCargoGlobal [_smokegrenade,1];
