...
_crew = ["vc","vg","vd"];
_ghillie = ["sn","sp"];
_specOp = ["prisoner","prisonerl"];

// Basic clothing
// The outfit-piece is randomly selected from the array for each unit

_baseUniform = ["U_OG_leader","U_OG_Guerilla1_1","U_OG_Guerilla2_1","U_OG_Guerilla2_2","U_OG_Guerilla2_3","U_OG_Guerilla3_1","U_OG_Guerilla3_2","U_OG_Guerrilla_6_1"];
...
// Spec Op (CTRG)
_sfuniform = ["U_C_WorkerCoveralls"];
_sfhelmet = [];
_sfRig = [];
_sfGlasses = [];
...
_pistolTypes = [["hgun_ACPC2_F","9Rnd_45ACP_Mag"],
