...
if (_unitfaction in ["blu_f","blu_t_f","blu_ctrg_f"]) then {
	...
	["UGV1",_ifv, "UGV1", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
	["UGV2", _ifv, "UGV2", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
	["UAV1",_pla, "UAV1", "ColorRed"] spawn f_fnc_localSpecialistMarker;
	["UAV2",_hel, "UAV2", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
};
