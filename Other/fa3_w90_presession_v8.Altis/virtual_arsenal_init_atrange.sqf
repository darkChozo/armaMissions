...
_availableLaunchers = ["launch_NLAW_F","launch_RPG7_F","launch_RPG32_F","launch_B_Titan_short_F"];

_availableMagazines = ["NLAW_F","RPG7_F","RPG32_F","RPG32_HE_F","Titan_AT","Titan_AP"];
