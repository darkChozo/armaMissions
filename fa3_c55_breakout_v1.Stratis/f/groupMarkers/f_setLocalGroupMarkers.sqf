...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_AH1",  9, "AH1", "ColorOrange"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["GrpAAF_ENG2",  6, "ENG2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		...
		["GrpAAF_AH1",  9, "AH1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpAAF_AH2",  9, "AH2", "ColorOrange"] spawn f_fnc_localGroupMarker;
