...
_baseUniform = ["U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_3_F","U_C_Man_casual_3_F","U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_BG_Guerilla3_1","U_C_Poor_1"];
_baseHelmet = ["H_Bandanna_khk","H_Bandanna_cbr","H_Bandanna_sand","H_Bandanna_surfer_blk","H_Beret_blk","H_Cap_blk","H_Cap_blk_CMMG","H_Cap_grn","H_Cap_red","H_Cap_usblack","H_Helmet_Skate"];
_baseGlasses = ["","","","","G_Bandanna_blk","G_Shades_Black","G_Spectacles","G_Squares"];

// Vests
_lightRig = ["V_BandollierB_blk","V_TacChestrig_grn_F","V_Rangemaster_belt"];
_standardRig = _lightRig;
...
_pistol = selectRandom [["hgun_Pistol_heavy_01_F","11Rnd_45ACP_Mag"],
...
if (_typeOfUnit in ["co","dc"]) then {
	_pistol = ["hgun_Pistol_heavy_02_F","6Rnd_45ACP_Cylinder"];
};

_unit addMagazines [_pistol select 1,10];
