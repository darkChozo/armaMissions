...
// Grenadier Loadout:
	...
	case "csat_weapons":
	{
		...
		_unit addWeaponCargoGlobal ["arifle_CTAR_blk_F", 5];
	};
	...
	case "csat_ammo":
	{
		...
		_unit addMagazineCargoGlobal ["100Rnd_580x42_Mag_Tracer_F", 10];
	...
	case "csat_special":
	{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addWeaponCargoGlobal ["launch_RPG32_ghex_F", 2];
		_unit addWeaponCargoGlobal ["arifle_ARX_ghex_F", 1];
