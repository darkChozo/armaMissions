...
_baseHelmet = ["H_HelmetB_light","H_HelmetB_light_grass","H_HelmetB_light_black"];
_baseGlasses = ["","","","","G_Balaclava_TI_tna_F","G_Balaclava_TI_blk_F"];

// Vests
_lightRig = ["V_PlateCarrier1_rgr_noflag_F"];
_standardRig = ["V_PlateCarrier2_rgr_noflag_F"];
...
// Pilot
_pilotUniform = ["U_B_CTRG_Soldier_F","U_B_CTRG_Soldier_2_F","U_B_CTRG_Soldier_3_F"];
_pilotHelmet = ["H_Watchcap_khk","H_Shemag_olive_hs","H_MilCap_tna_F","H_Cap_khaki_specops_UK","H_Bandanna_camo","H_Bandanna_cbr","H_Bandanna_khk_hs","H_Booniehat_khk","H_Booniehat_khk_hs","H_Booniehat_oli","H_Booniehat_tna_F"];
