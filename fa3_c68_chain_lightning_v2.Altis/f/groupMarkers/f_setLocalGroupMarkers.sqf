...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["UnitCSAT_TH1_P",  2, "TH1", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TH2_P",  2, "TH2", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TH3_P",  2, "TH3", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TH4_P",  2, "TH4", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
        ...
        //AAF markers
		["GrpAAF_CO", 0, "", "ColorIndependent"] spawn f_fnc_localGroupMarker;

		["GrpAAF_ASL", 0, "", "ColorIndependent"] spawn f_fnc_localGroupMarker;
		["GrpAAF_A1", 1, "", "ColorIndependent"] spawn f_fnc_localGroupMarker;
		["GrpAAF_A2", 1, "", "ColorIndependent"] spawn f_fnc_localGroupMarker;

		["GrpAAF_BSL", 0, "", "ColorIndependent"] spawn f_fnc_localGroupMarker;
		["GrpAAF_B1", 1, "", "ColorIndependent"] spawn f_fnc_localGroupMarker;
		["GrpAAF_B2", 1, "", "ColorIndependent"] spawn f_fnc_localGroupMarker;

		["UnitAAF_TH1_P",  2, "", "ColorIndependent"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_TH2_P",  2, "", "ColorIndependent"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_TH3_P",  2, "", "ColorIndependent"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_TH4_P",  2, "", "ColorIndependent"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_CO_P",  2, "", "ColorIndependent"] spawn f_fnc_localSpecialistMarker;
	};
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["UnitAAF_TH1_P",  2, "TH1", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_TH2_P",  2, "TH2", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_TH3_P",  2, "TH3", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_TH4_P",  2, "TH4", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitAAF_CO_P",  2, "COH", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
        ...
        //CSAT markers
		["GrpCSAT_CO", 0, "", "ColorOPFOR"] spawn f_fnc_localGroupMarker;

		["GrpCSAT_ASL", 0, "", "ColorOPFOR"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_A1", 1, "", "ColorOPFOR"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_A2", 1, "", "ColorOPFOR"] spawn f_fnc_localGroupMarker;

		["GrpCSAT_BSL", 0, "", "ColorOPFOR"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_B1", 1, "", "ColorOPFOR"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_B2", 1, "", "ColorOPFOR"] spawn f_fnc_localGroupMarker;

		["UnitCSAT_TH1_P",  2, "", "ColorOPFOR"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TH2_P",  2, "", "ColorOPFOR"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TH3_P",  2, "", "ColorOPFOR"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TH4_P",  2, "", "ColorOPFOR"] spawn f_fnc_localSpecialistMarker;
	};
// ====================================================================================
