...
_baseUniform = ["U_BG_Guerrilla_6_1","U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_2","U_BG_Guerilla3_1","U_BG_Guerilla3_2","U_C_HunterBody_grn","U_C_WorkerCoveralls"];
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
        ...
        for "_i" from 1 to 8 + random 8 do {
            (unitBackpack _unit) addItemCargoGlobal [["ItemWatch","ItemCompass","ItemRadio","ItemMap","MineDetector","Binocular","FirstAidKit","muzzle_snds_L","muzzle_snds_B","optic_ACO_grn","muzzle_snds_acp","bipod_01_F_snd","bipod_03_F_blk"] call BIS_fnc_selectRandom,1];
        };
	};
