...
_baseUniform = ["U_OG_Guerilla2_1","U_OG_Guerilla2_3","U_I_C_Soldier_Para_4_F","U_OG_Guerilla3_1","U_I_C_Soldier_Bandit_3_F"];
_baseHelmet = ["H_Shemag_olive","H_ShemagOpen_tan"];
_baseGlasses = ["","","","","","","G_Shades_Black","G_Squares_Tinted"];
