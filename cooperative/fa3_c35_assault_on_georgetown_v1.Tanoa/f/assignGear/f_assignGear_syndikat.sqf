...
// Vests
_lightRig = ["V_TacVest_khk","V_TacVest_oli","V_TacVest_camo","V_TacVest_blk"];
...
// Spec Op
_sfuniform = ["U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_3_F","U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_4_F"];;
