...
case "g":
{
	...
	if (_loadout == 0) then {
		...
		_unit addmagazines [_incinerateGrenade,1];
	};
	// LOADOUT: MEDIUM
	if (_loadout == 1) then {
		_unit addBackpack (_bagMedium call BIS_fnc_selectRandom);
		...
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellRed",1];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellGreen",1];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellYellow",1];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellPurple",1];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellBlue",1];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellOrange",1];		// Do not use with mgrenades
	};
	// LOADOUT: HEAVY
	if (_loadout == 2) then {
		_unit addBackpack (_bagMedium call BIS_fnc_selectRandom);
		...
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellRed",2];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellGreen",2];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellYellow",2];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellPurple",2];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellBlue",2];		// Do not use with mgrenades
		(unitBackpack _unit) addMagazineCargoGlobal ["SmokeShellOrange",2];		// Do not use with mgrenades
	};
};
...
case "aar":
{
	// LOADOUT: LIGHT
	if (_loadout == 0) then {
		_unit addmagazines [_incinerateGrenade,4];
	};
	// LOADOUT: MEDIUM
	if (_loadout == 1) then {
		_unit addBackpack (_bagMedium call BIS_fnc_selectRandom);
		...
		//(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 5];	// Do not use with grenades
		(unitBackpack _unit) addMagazineCargoGlobal [_incinerateGrenade,9];
	};
	// LOADOUT: HEAVY
	if (_loadout == 2) then {
		_unit addBackpack (_bagMedium call BIS_fnc_selectRandom);
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_incinerateGrenade, 15];
	};
};
...
case "rat":
{
	...
	if (_loadout == 2) then {
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_RATmag, 6];
	};
};
