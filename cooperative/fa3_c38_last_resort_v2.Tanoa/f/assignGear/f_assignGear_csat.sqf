...
// Diver
_diverWep = "arifle_CTAR_ghex_F";
_diverMag1 = "30Rnd_580x42_Mag_F";
_diverMag2 = "30Rnd_580x42_Mag_Tracer_F";
...
// Backpacks
_bagsmall = "B_ViperLightHarness_ghex_F";			// carries 120, weighs 20
_bagmedium = "B_ViperLightHarness_ghex_F";			// carries 200, weighs 30
_baglarge =  "B_ViperLightHarness_ghex_F"; 			// carries 320, weighs 40
...
// Vests
_lightRig = ["V_BandollierB_ghex_F"];
_mediumRig = ["V_HarnessOGL_ghex_F"]; 	// default for all infantry classes
...
// LOADOUT: RIFLEMAN (AT)
	case "rat":
	{
		_unit addmagazines ["30Rnd_65x39_caseless_green",4];
		_unit addmagazines ["30Rnd_65x39_caseless_green_mag_Tracer",3];
