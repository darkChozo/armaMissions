...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_HMG1",  7, "HMG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_GMG1",  7, "GMG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		...
		["UnitCSAT_JSL_M", 0, "JM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	};
