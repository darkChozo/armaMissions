...
if (_unitfaction in ["blu_f","blu_t_f","blu_ctrg_f"]) then {
	...
	["GrpNATO_TNK1",_tnk, "TNK1", "ColorPink"] spawn f_fnc_localGroupMarker;
	["GrpNATO_AAA1",_tnk, "AAA1", "ColorPink"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_TH7",_hel, "TH7", "ColorCIV"] spawn f_fnc_localGroupMarker;
	["GrpNATO_TH8",_hel, "TH8", "ColorCIV"] spawn f_fnc_localGroupMarker;
