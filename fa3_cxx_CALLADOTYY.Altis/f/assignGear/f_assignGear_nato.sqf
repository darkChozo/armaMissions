...
// Default setup
_attachments = [_attach1,_silencer2,_scope2]; // The default attachment set for most units, overwritten in the individual unitType
...
_baseHelmet = ["H_Cap_headphones","H_HelmetB_light_snakeskin","H_Watchcap_cbr","H_Booniehat_khk_hs","H_Watchcap_blk"];
_baseGlasses = [];
