...
<br/><br/>
The terrorists don't appear to have vehicles, so it'll be difficult for them to leave the wind farm before we show up. We should be able to attack from pretty much any angle, but be careful.
<br/><br/>
...
<br/>
Eight minutes ago, terrorists seized <marker name='windfarm'>Therisa Wind Farm</marker>, killed all the workers, and set up some sort of explosive device.
<br/><br/>
We're the only ones close enough to respond in time. Join up with the police already on-site, and defuse that bomb.
<br/><br/>
<font size='18'>ENEMY FORCES</font>
<br/>
Standard-issue <marker name='terrorists'>terrorists</marker> equipped with assault rifles and mines.
<br/><br/>
