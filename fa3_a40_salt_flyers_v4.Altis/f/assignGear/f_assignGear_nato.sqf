...
// CARGO: CAR - room for 10 weapons and 50 cargo items
	case "v_car":
	{
		...
		_unit addMagazineCargoGlobal ["30Rnd_45ACP_Mag_SMG_01_tracer_green", 1000];
		_unit addMagazineCargoGlobal ["150Rnd_762x54_Box_Tracer", 1000];
		_unit addMagazineCargoGlobal ["200Rnd_65x39_cased_Box_Tracer", 1000];
		_unit addMagazineCargoGlobal ["150Rnd_93x64_Mag", 1000];
		_unit addMagazineCargoGlobal ["130Rnd_338_Mag", 1000];
		_unit addMagazineCargoGlobal ["5Rnd_127x108_APDS_Mag", 1000];
	};
