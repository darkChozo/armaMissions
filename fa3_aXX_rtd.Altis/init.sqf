...
blucars = [VehFIA_IFV1,VehFIA_IFV2,VehFIA_IFV3,VehFIA_IFV4,VehFIA_IFV5,VehFIA_IFV6,VehFIA_IFV7,VehFIA_IFV8];
redcars = [VehOFIA_IFV1,VehOFIA_IFV2,VehOFIA_IFV3,VehOFIA_IFV4,VehOFIA_IFV5,VehOFIA_IFV6,VehOFIA_IFV7,VehOFIA_IFV8];

{
	[_x, 4, ["HidePolice", 1, "HideServices", 1, "HideBackpacks", 1, "HideBumper1", 1, "HideBumper2", 1, "HideConstruction", 1, "HideDoor3", (1/3)]] call BIS_fnc_initVehicle;
	[_x] execVM "randomStupidWeapon.sqf";
	_x allowCrewInImmobile true;
} foreach blucars;
{
	[_x, 2, ["HidePolice", 1, "HideServices", 1, "HideBackpacks", 1, "HideBumper1", 1, "HideBumper2", 1, "HideConstruction", 1, "HideDoor3", (1/3)]] call BIS_fnc_initVehicle;
	[_x] execVM "randomStupidWeapon.sqf";
	_x allowCrewInImmobile true;
} foreach redcars;
...
{_x addEventHandler ["Killed", {
	if ({alive _x} count units group (_this select 0) == 0) then {
		[vehicle (_this select 1)] execVM "randomStupidWeapon.sqf"
	};
