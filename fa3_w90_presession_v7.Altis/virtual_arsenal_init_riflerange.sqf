...
_availableItems = ["ItemGPS","Rangefinder","Binocular","FirstAidKit","optic_Arco","optic_Hamr","optic_Aco","optic_Aco_smg","optic_Holosight","optic_Holosight_smg","optic_SOS","optic_MRCO","acc_pointer_IR","acc_flashlight","optic_DMS","optic_LRPS","optic_AMS","optic_KHS_blk","bipod_01_F_blk"];
