...
_riflemag_tr = "30Rnd_762x39_Mag_F";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_AKM_F"]; // Slight randomization, biased towards TRG
_carbinemag = "30Rnd_762x39_Mag_F";
_carbinemag_tr = "30Rnd_762x39_Mag_F";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "arifle_AKS_F";
_smgmag = "30Rnd_545x39_Mag_F";
_smgmag_tr = "30Rnd_545x39_Mag_F";
...
// Backpacks
_bagsmall = "B_FieldPack_cbr";			// carries 160, weighs 20
...
_baseGlasses = ["G_Bandanna_aviator","G_Bandanna_khk","G_Bandanna_oli","G_Balaclava_blk","G_Balaclava_oli","G_Spectacles_Tinted","G_Aviator"];

// Vests
_lightRig = ["V_BandollierB_blk","V_BandollierB_rgr"];
_mediumRig = ["V_TacVest_blk","V_TacVest_khk","V_TacVest_brn","V_TacVest_oli"]; 	// default for all infantry classes
