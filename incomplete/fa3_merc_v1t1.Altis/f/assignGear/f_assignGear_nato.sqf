...
_baseUniform = ["U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_I_C_Soldier_Para_4_F"];
_baseHelmet = [];
_baseGlasses = ["G_Balaclava_blk","G_Balaclava_lowprofile"];
