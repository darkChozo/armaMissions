...
// Automatic Rifleman Loadout:
	case "ar":
	{
		...
		_unit addweapon _AR;
		_attachments pushback (_bipod2); // Adds the bipod
...
// Rifleman (AT) Loadout:
	case "rat":
	{
		_unit addmagazines ["10Rnd_127x54_Mag", 1];
		_unit addweapon "srifle_DMR_04_F";
		_unit addItem _firstaid;
		_unit addmagazines [_smokegrenade, 3];
		_unit addmagazines ["10Rnd_127x54_Mag", 4];
		_unit addmagazines [_grenade, 2];
		_attachments = [_scope2,_bipod2];
	};
...
// Engineer (Demo) Loadout:
	case "eng":
	{
		...
		_unit addmagazines ["SLAMDirectionalMine_Wire_Mag", 1];
		_unit addmagazines [_APmine2, 1];
	};
