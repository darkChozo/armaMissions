...
_vicConfigs = [
	...
	["B_MRAP_01_F",[0,-5,-1.5],[
		[[1.4,-1.4,-1.4],0,"passenger_boat_holdleft2",[1.7,-1.2,-1.4],90],  		//front right
		[[-1.4,-1.4,-1.4],0,"passenger_boat_holdright",[-1.7,-1.2,-1.4],-90],	//front left
		[[1.4,-2.1,-1.4],0,"passenger_boat_holdleft",[1.7,-2.1,-1.4],90], 		//back right
		[[-1.4,-2.1,-1.4],0,"passenger_boat_holdright2",[-1.7,-2.1,-1.4],-90]   //back left
	]],
	["MRAP_01_gmg_base_F",[0,-5,-2],[
		[[1.4,-1.4,-2],0,"passenger_boat_holdleft2",[1.4,-1.4,-2],90],  		//front right
		[[-1.4,-1.4,-2],0,"passenger_boat_holdright",[-1.4,-1.4,-2],-90],   //front left
		[[1.4,-2.1,-2],0,"passenger_boat_holdleft",[1.4,-2.1,-2],90], 		//back right
		[[-1.4,-2.1,-2],0,"passenger_boat_holdright2",[-1.4,-2.1,-2],-90]   //back left
	]]
