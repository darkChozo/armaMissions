...
// Backpacks
_bagpara = "B_Parachute";
_bagsmall = "B_Parachute";			// carries 120, weighs 20
_bagmedium = "B_Parachute";			// carries 200, weighs 30
_baglarge =  "B_Parachute"; 			// carries 320, weighs 40
...
_baseHelmet = ["H_HelmetLeaderO_ocamo","H_HelmetSpecO_ocamo"];
_baseGlasses = [];
