...
_baseUniform = ["U_I_C_Soldier_Camo_F","U_I_C_Soldier_Camo_F","U_I_C_Soldier_Camo_F","U_I_C_Soldier_Para_3_F"];
_baseHelmet = ["H_HelmetB","H_HelmetB","H_HelmetB","H_Cap_oli","H_Bandanna_khk"];
_baseGlasses = [];
