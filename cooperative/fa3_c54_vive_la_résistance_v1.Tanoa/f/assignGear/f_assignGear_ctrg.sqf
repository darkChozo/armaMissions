...
_baghatg = "B_Kitbag_rgr";			// used by Heavy AT gunner
...
_baseUniform = ["U_B_CTRG_Soldier_urb_1_F","U_B_CTRG_Soldier_urb_2_F","U_B_CTRG_Soldier_urb_3_F"];
...
// Vests
_lightRig = ["V_PlateCarrier2_rgr_noflag_F"];
