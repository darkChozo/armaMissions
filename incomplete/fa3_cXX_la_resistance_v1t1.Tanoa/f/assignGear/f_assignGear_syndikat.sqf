...
_rifle = "hgun_PDW2000_F"; // Slight randomization, biased towards TRG
...
_glrifle = "hgun_PDW2000_F"; // Slight randomization, biased towards TRG
...
// Automatic Rifleman
_AR = "srifle_DMR_06_olive_F";
_ARmag = "20Rnd_762x51_Mag";
_ARmag_tr = "20Rnd_762x51_Mag";
...
_baseHelmet = ["H_Bandanna_gry","H_Bandanna_khk","H_Bandanna_sgg","H_Bandanna_cbr"];
_baseGlasses = ["","","","","","","","","G_Shades_Black","G_Shades_Green","G_Sport_Blackyellow","G_Sport_Checkered"];

// Vests
_standardRig = ["V_TacVest_blk"];
_lightRig = _standardRig;
...
// Spec Op
_sfuniform = ["U_B_CTRG_Soldier_urb_2_F"];
_sfhelmet = ["H_Bandanna_khk"];
_sfRig = ["V_PlateCarrier1_rgr_noflag_F"];
_sfGlasses = ["G_Squares_Tinted"];

if (side _unit == east) then {
	// Basic clothing
	// The outfit-piece is randomly selected from the array for each unit
	_baseUniform = ["U_OG_Guerilla2_2","U_OG_Guerilla2_1","U_OG_Guerilla2_3"];
	_baseHelmet = [];
	_baseGlasses = ["G_Bandanna_blk","G_Bandanna_oli","G_Bandanna_sport","G_Bandanna_aviator"];
...
switch (_typeOfUnit) do {
	...
	case "co" : {
		_weapon = ["hgun_Pistol_heavy_02_F","6Rnd_45ACP_Cylinder"];
	};
...
_unit addmagazines [_weapon select 1, 8];
