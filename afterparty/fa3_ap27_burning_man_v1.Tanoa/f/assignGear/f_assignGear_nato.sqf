...
_baseUniform = ["U_OrestesBody","U_NikosBody","U_C_Poloshirt_blue","U_C_Poloshirt_burgundy","U_C_Poloshirt_stripped","U_C_Poloshirt_tricolour","U_C_Poloshirt_salmon","U_C_Poloshirt_redwhite","U_Competitor","U_IG_Guerilla2_1","U_C_Man_casual_4_F"];
_baseHelmet = [];
_baseGlasses = [];
