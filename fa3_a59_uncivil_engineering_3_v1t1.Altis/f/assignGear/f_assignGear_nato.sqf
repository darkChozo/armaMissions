...
_baseUniform = ["U_C_Journalist"];
_baseHelmet = ["H_Cap_police"];
_baseGlasses = ["None","G_Aviator","G_Shades_Black","G_Squares_Tinted","G_Spectacles_Tinted"];
...
// Diver
_diverUniform =  ["U_Marshal"];
_diverHelmet = ["H_HelmetB_plain_blk"];
_diverRig = ["V_PlateCarrierSpec_blk"];
_diverGlasses = ["G_Balaclava_blk","G_Balaclava_combat","G_Balaclava_lowprofile"];
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
		...
		_unit addWeapon "Binocular";
        _unit linkItem _nvg;
        _attachments = [_silencer2,_attach1];
...
// LOADOUT: CARABINEER
	case "car":
	{
		_unit addmagazines ["9Rnd_45ACP_Mag",7];
		_unit addweapon "hgun_ACPC2_F";
	};
