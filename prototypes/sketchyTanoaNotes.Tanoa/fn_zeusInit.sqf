f_fnc_zeusAddAddons = compileFinal preprocessFileLineNumbers "fn_zeusAddAddons.sqf";
f_fnc_zeusAddObjects = compileFinal preprocessFileLineNumbers "fn_zeusAddObjects.sqf";
