...
_baseGlasses = ["G_Bandanna_shades","G_Aviator","G_Spectacles_Tinted","G_Shades_Blue"];
...
_unit addMagazines ["30Rnd_9x21_Mag_SMG_02",8];
_unit addWeapon "SMG_05_F";
if (_unitType in _specOp) then {
