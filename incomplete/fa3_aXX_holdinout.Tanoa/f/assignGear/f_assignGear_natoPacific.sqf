...
_scope1 = "optic_Aco_smg";	// Basic Scope
_scope2 = "optic_Hamr_khk_F";		// RCO Scope
_scope3 = "optic_LRPS";		// LRPS
...
_baseUniform = ["U_B_T_Soldier_AR_F","U_B_T_Soldier_SL_F"];
...
// Ghillie
_ghillieUniform = ["U_B_T_Soldier_SL_F"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = [];
