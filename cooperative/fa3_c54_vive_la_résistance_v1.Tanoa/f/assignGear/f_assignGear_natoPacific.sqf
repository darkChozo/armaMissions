...
_baseUniform = ["U_C_man_sport_1_F","U_C_man_sport_2_F","U_C_man_sport_3_F","U_C_Man_casual_1_F","U_C_Man_casual_2_F","U_C_Man_casual_3_F","U_C_Man_casual_4_F","U_C_Man_casual_5_F","U_C_Man_casual_6_F"];
_baseHelmet = [];
_baseGlasses = [];

// Vests
_lightRig = ["V_TacVestIR_blk","V_TacVest_gen_F"];
