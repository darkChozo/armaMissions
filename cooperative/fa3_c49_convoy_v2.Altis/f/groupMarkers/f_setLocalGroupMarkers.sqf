...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		["GrpAAF_CO", 7, "CO", "ColorYellow"] spawn f_fnc_localGroupMarker;

		["GrpAAF_APL", 7, "APL", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_A1", 7, "A1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_A2", 7, "A2", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_A3", 7, "A3", "ColorRed"] spawn f_fnc_localGroupMarker;

		["GrpAAF_BPL", 7, "BPL", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpAAF_B1", 7, "B1", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpAAF_B2", 7, "B2", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpAAF_B3", 7, "B3", "ColorBlue"] spawn f_fnc_localGroupMarker;

		["GrpAAF_CPL", 7, "CPL", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_C1", 7, "C1", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_C2", 7, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_C3", 7, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		...
		["GrpAAF_RCN1", 0, "RCN1", "ColorPink"] spawn f_fnc_localGroupMarker;
		["GrpAAF_RCN2", 1, "RCN2", "ColorPink"] spawn f_fnc_localGroupMarker;
