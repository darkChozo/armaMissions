...
_carbine = ["arifle_AKM_FL_F"]; // Slight randomization, biased towards TRG
_carbinemag = "30Rnd_762x39_Mag_Green_F";
_carbinemag_tr = "30Rnd_762x39_Mag_Tracer_Green_F";
...
_baseHelmet = ["H_Shemag_khk","H_Shemag_tan","H_Shemag_olive","H_Shemag_olive_hs","H_ShemagOpen_khk","H_ShemagOpen_tan"];
...
// LOADOUT: ENGINEER (MINES)
	case "engm":
	{
		...
		(unitBackpack _unit) addMagazineCargoGlobal ["IEDUrbanSmall_Remote_Mag",1];
