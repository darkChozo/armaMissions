...
_bipod1 = "bipod_03_F_blk";		// Default bipod
...
_rifle = ["arifle_AKM_FL_F"]; // Slight randomization, biased towards TRG
...
_crew = ["vc","vg","vd"];
_ghillie = ["sn","sp"];
_specOp = ["co","dc","mmgg","mmgag","matgg","matag"];
...
_baseHelmet = ["H_Bandanna_gry","H_Bandanna_khk","H_Bandanna_blu","H_Booniehat_oli","H_Cap_oli","H_Cap_blk_CMMG",""];
_baseGlasses = ["G_Bandanna_beast","G_Bandanna_oli","G_Aviator","G_Shades_Black","G_Spectacles_Tinted","","","",""];

// Vests
_lightRig = ["V_BandollierB_blk","V_BandollierB_rgr"];
_mediumRig = ["V_TacVest_camo","V_TacVest_oli","V_TacVest_brn","V_TacVest_blk"]; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_3_F"];
...
// Spec Op (CTRG)
_sfuniform = ["U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F","U_I_C_Soldier_Para_4_F","U_I_C_Soldier_Para_5_F"];
