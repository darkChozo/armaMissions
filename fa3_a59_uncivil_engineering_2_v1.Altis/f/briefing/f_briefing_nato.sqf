...
<br/>
Eight minutes ago, terrorists seized <marker name='windfarm'>the construction site near Neochori</marker>, killed all the workers, and set up some sort of explosive device.
<br/><br/>
