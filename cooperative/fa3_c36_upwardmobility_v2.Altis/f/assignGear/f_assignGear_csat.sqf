...
// Woodland-Hex
_baseUniform = ["U_Competitor","U_C_Journalist","U_Marshal","U_Rangemaster","U_C_Poor_1","U_I_G_resistanceLeader_F","U_KerryBody","U_NikosAgedBody"];
_baseHelmet = ["H_Booniehat_khk_hs","U_Rangemaster","H_Cap_oli_hs","H_Bandanna_khk_hs","H_Cap_marshal","H_Watchcap_blk","H_Watchcap_camo"];
_baseGlasses = [];
...
_mediumRig = ["V_TacVest_khk","V_TacVest_brn","V_TacVest_oli","V_TacVest_blk","V_TacVest_camo","V_PlateCarrier1_rgr","V_PlateCarrier1_blk","V_PlateCarrierIA1_dgtl"]; 	// default for all infantry classes
