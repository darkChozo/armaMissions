...
_rifle = ["arifle_AKM_F"]; // Slight randomization, biased towards TRG
...
// Backpacks
_bagsmall = "B_FieldPack_oli";			// carries 160, weighs 20
...
_baseUniform = ["U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F","U_I_C_Soldier_Para_4_F","U_I_C_Soldier_Para_5_F"];
_baseHelmet = [];
_baseGlasses = ["G_Bandanna_khk","G_Bandanna_oli","G_Bandanna_beast","G_Aviator","G_Shades_Red","G_Sport_Greenblack","G_Sport_Checkered","G_Sport_Blackyellow","","","",""];

// Vests
_lightRig = ["V_BandollierB_blk","V_BandollierB_rgr"];
_mediumRig = ["V_TacVest_oli","V_TacVest_camo","V_TacVest_brn"]; 	// default for all infantry classes
...
_backpack = {
	...
	{
		#include "f_assignGear_syndikat_b.sqf";
	};
};
...
// LOADOUT: UNARMED
	case "ua": {
		_unit addMagazines ["30Rnd_762x39_Mag_F",4];
		_unit addMagazines ["30Rnd_762x39_Mag_Tracer_F",3];
...
// LOADOUT: UNARMED
	...
	case "rpg":
	{
		...
		unitBackpack (_unit) addMagazineCargoGlobal ["RPG7_F",3];
	...
	case "ammo":
	{
		...
		_unit addWeapon "arifle_AKM_F"; 
		_unit addBackpack "B_FieldPack_oli";
		unitBackpack (_unit) addMagazineCargoGlobal ["30Rnd_762x39_Mag_F",10];
		unitBackpack (_unit) addMagazineCargoGlobal ["30Rnd_762x39_Mag_Tracer_F",10];
	};
// LOADOUT: COMMANDER
	case "co":
	{
...
// LOADOUT: DEFAULT/UNDEFINED (use RIFLEMAN)
   default
   {
		...
		if (true) exitwith {player globalchat format ["DEBUG (f\assignGear\f_assignGear_syndikat.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofunit]};
   };
