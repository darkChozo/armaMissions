...
_baseUniform = ["U_I_C_Soldier_Camo_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F","U_I_C_Soldier_Para_4_F","U_I_C_Soldier_Para_1_F"];
_baseHelmet = ["H_ShemagOpen_khk","H_ShemagOpen_tan","H_Shemag_olive"];
_baseGlasses = [];
...
_unit addBackpack selectRandom ["B_AssaultPack_khk","B_AssaultPack_rgr","B_AssaultPack_cbr","B_AssaultPack_blk"];
_unit addMagazines ["9Rnd_45ACP_Mag",8];
...
switch (_typeofUnit) do
{
	...
	case "ftl": {
		_unit addItem _mgrenade;
	};
	case "dc": {
		_unit addItem _smokegrenade;
	};
};
