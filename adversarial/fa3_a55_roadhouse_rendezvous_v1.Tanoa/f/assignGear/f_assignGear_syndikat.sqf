...
_standardRig = ["V_TacVest_blk","V_TacVest_oli"];
...
// Ghillie
_ghillieUniform = ["U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Camo_F"];
_ghillieHelmet = ["H_Booniehat_oli","H_Cap_blk_CMMG","H_Booniehat_dgtl"];
_ghillieRig = ["V_Chestrig_rgr","V_Chestrig_oli"];
