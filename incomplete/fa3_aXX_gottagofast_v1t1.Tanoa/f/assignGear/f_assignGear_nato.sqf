...
_baseHelmet = ["","H_Cap_police","H_Beret_gen_F"];
_baseGlasses = ["","","","","","G_Aviator","G_Bandanna_blk","G_Bandanna_beast","G_Bandanna_shades","G_Lady_Mirror","G_Squares_Tinted"];
