...
// Spec Op
_sfuniform = ["U_O_T_Officer_F"];		//Viper: ["U_O_V_Soldier_Viper_F"];
_sfhelmet = ["H_Beret_blk"];	//Viper: ["H_HelmetO_ViperSP_ghex_F"]; IMPORTANT: Will be overriden if nvg is added afterwards
