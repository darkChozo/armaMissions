...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_IFV2",  7, "AAA1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_AP1",  9, "AP1", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["UnitCSAT_TRK1", 2, "TRK1", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TRK2", 2, "TRK2", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TRK3", 2, "TRK3", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_TRK4", 2, "TRK4", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
	};
