...
if (hasInterface) then {
    ...
    },nil,7,true,true,"","!isNull cursorObject && {player distance cursorObject < 4 && player getVariable 'suppliesCount' == 0 && !isNil {cursorObject getVariable ['suppliesCount',nil]} && {cursorObject getVariable 'suppliesCount' > 0}}"];
