...
_baseHelmet = ["H_Shemag_olive","H_ShemagOpen_tan","H_Bandanna_khk","H_Booniehat_khk","H_Cap_oli","H_Hat_camo","H_HelmetB_grass","H_HelmetB_black",""];
_baseGlasses = ["G_Bandanna_aviator","G_Bandanna_khk","G_Balaclava_blk","G_Balaclava_oli","G_Shades_Black","G_Shades_Red","G_Sport_Blackyellow","G_Aviator",""];

// Vests
_lightRig = ["V_BandollierB_blk","V_BandollierB_rgr"];
_mediumRig = ["V_TacVest_blk","V_TacVest_camo","V_TacVest_oli","V_TacVest_khk","V_Chestrig_blk","V_Chestrig_oli"]; 	// default for all infantry classes
...
// Spec Op (CTRG)
_sfuniform = ["U_IG_leader","U_IG_Guerilla1_1","U_IG_Guerrilla_6_1"];
_sfhelmet = ["H_Beret_blk","H_Beret_grn"];
_sfRig = ["V_PlateCarrier2_rgr"];
_sfGlasses = ["","G_Shades_Black","G_Shades_Red","G_Sport_Blackyellow","G_Aviator"];
...
// LOADOUT: HEAVY MG ASSISTANT GUNNER
	case "hmgag":
	{
		...
		//_unit addmagazines [_mgrenade,1];		// Do not use with grenades
		_unit addmagazines [_smokegrenade,1];
		["hmgag",0] call _backpack;
	};

// LOADOUT: MEDIUM AT GUNNER
	case "matg":
	{
		["matg",0] call _backpack;
		_unit addmagazines [_carbinemag,7];
		_unit addmagazines [_carbinemag_tr,2];
		_unit addmagazines [_smokegrenade,2];
		_unit addweapon (_carbine call BIS_fnc_selectRandom);
...
// LOADOUT: MORTAR ASSISTANT GUNNER
	case "mtrag":
	{
		...
		_unit addmagazines [_smokegrenade,1];
		_unit addWeapon "Rangefinder";
		["mtrag",0] call _backpack;
	};

// LOADOUT: MEDIUM SAM GUNNER
	case "msamg":
	{
		["msamg",0] call _backpack;
		_unit addmagazines [_carbinemag,7];
		_unit addmagazines [_carbinemag_tr,2];
		_unit addweapon (_carbine call BIS_fnc_selectRandom);
		_unit addmagazines [_smokegrenade,1];
