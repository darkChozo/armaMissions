...
_rifle = "hgun_Pistol_heavy_01_F";
_riflemag = "11Rnd_45ACP_Mag";
_riflemag_tr = "11Rnd_45ACP_Mag";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "hgun_Pistol_heavy_01_F";
_carbinemag = "11Rnd_45ACP_Mag";
_carbinemag_tr = "11Rnd_45ACP_Mag";
...
_glrifle = "hgun_Pistol_heavy_02_F";
_glriflemag = "6Rnd_45ACP_Cylinder";
_glriflemag_tr = "6Rnd_45ACP_Cylinder";
_glmag = "6Rnd_45ACP_Cylinder";		// Ideal for Adversarial - Do not use with 3 Round version
...
_incinerateGrenade = "B_IR_Grenade";
...
// Backpacks
_bagMedium = ["B_Kitbag_cbr","B_FieldPack_khk","B_FieldPack_cbr"];			// carries 240, weighs 30
...
// Automatic Rifleman
_AR = "hgun_PDW2000_F";
_ARmag = "30Rnd_9x21_Mag";
_ARmag_tr = "30Rnd_9x21_Mag";
...
_baseUniform = ["U_I_G_resistanceLeader_F","U_BG_Guerrilla_6_1","U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_2","U_BG_Guerilla3_1","U_BG_Guerilla3_2","U_BG_leader","U_C_HunterBody_grn","U_I_G_Story_Protagonist_F","U_C_WorkerCoveralls"];
_baseHelmet = ["H_Cap_red","H_Cap_blu","H_Cap_blk_ION","H_Cap_surfer","H_MilCap_rucamo","H_MilCap_gry","H_Bandanna_surfer_blk","H_Bandanna_cbr","H_Bandanna_khk","H_Beret_grn","U_C_Poor_1"];
_baseGlasses = ["G_Bandanna_aviator","G_Bandanna_khk","G_Bandanna_beast","G_Bandanna_shades","G_Shades_Black","G_Shades_Red","G_Sport_Blackyellow","G_Aviator"];

// Armored vests
_lightRig = ["V_BandollierB_khk","V_BandollierB_cbr","V_BandollierB_blk","V_HarnessO_brn","V_HarnessO_gry","V_HarnessOGL_gry","V_Chestrig_khk"];
_mediumRig = ["V_BandollierB_khk","V_BandollierB_cbr","V_BandollierB_blk","V_HarnessO_brn","V_HarnessO_gry","V_HarnessOGL_gry","V_Chestrig_khk"]; 	// default for all infantry classes
_heavyRig = ["V_BandollierB_khk","V_BandollierB_cbr","V_BandollierB_blk","V_HarnessO_brn","V_HarnessO_gry","V_HarnessOGL_gry","V_Chestrig_khk"];
...
// Crewman
_crewUniform = ["U_C_Scientist"];
_crewHelmet = ["H_PilotHelmetFighter_I"];
...
// LOADOUT: COMMANDER
	case "co":
	{
		...
		_unit addmagazines ["SmokeShellRed",1];		// Do not use with mgrenades
		_unit addmagazines ["SmokeShellGreen",1];		// Do not use with mgrenades
		_unit addmagazines ["SmokeShellYellow",1];		// Do not use with mgrenades
		_unit addmagazines ["SmokeShellPurple",1];		// Do not use with mgrenades
		_unit addmagazines ["SmokeShellBlue",1];		// Do not use with mgrenades
		_unit addmagazines ["SmokeShellOrange",1];		// Do not use with mgrenades
