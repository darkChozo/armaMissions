...
_diver = ["div"];
_pilot = ["pp","pcc","pc"];
_crew = ["vc","vg","vd","journo"];
_ghillie = ["sn","sp"];
_specOp = ["co"];

// Basic clothing
// The outfit-piece is randomly selected from the array for each unit
_baseUniform = ["U_B_T_Soldier_F","U_B_T_Soldier_AR_F"];
_baseHelmet = [];
_baseGlasses = [];

// Vests
_lightRig = ["V_PlateCarrier1_tna_F"];
_standardRig = ["V_PlateCarrier1_tna_F"];
...
// Pilot
_pilotUniform = ["U_B_T_Soldier_F"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["V_TacVest_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_IG_Guerilla2_3"];
_crewHelmet = [];
_crewRig = ["V_Press_F"];
_crewGlasses = [];
...
// Spec Op
_sfuniform = ["U_B_T_Soldier_SL_F"];
_sfhelmet = ["H_Beret_02"];
_sfRig = [];
_sfGlasses = [];
