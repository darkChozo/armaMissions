...
_rifle = "arifle_AKS_F";
_riflemag = "30Rnd_545x39_Mag_F";
_riflemag_tr = "30Rnd_545x39_Mag_F";
...
_baseUniform = ["U_C_man_sport_1_F","U_C_man_sport_2_F","U_C_man_sport_3_F"];
_baseHelmet = ["H_Bandanna_surfer","H_Bandanna_surfer_blk","H_Bandanna_surfer_blk"];
_baseGlasses = [];

// Armored vests
_lightRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_camo","V_TacVest_oli"];
_mediumRig = ["V_BandollierB_blk","V_BandollierB_rgr"]; 	// default for all infantry classes
