...
_riflemag = "30Rnd_762x39_Mag_Green_F";
...
_glrifle = "arifle_AKM_FL_F"; // Slight randomization, biased towards TRG
_glriflemag = "30Rnd_762x39_Mag_Green_F";
...
// Backpacks
_bag = "B_TacticalPack_rgr";			// carries 160, weighs 20
_baglarge =  "B_TacticalPack_rgr"; 				// carries 320, weighs 60
...
_baseUniform = ["U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_3_F","U_I_C_Soldier_Bandit_4_F","U_I_C_Soldier_Bandit_5_F","U_C_Poloshirt_tricolour","U_IG_Guerilla2_3"];
_baseHelmet = ["H_Beret_blk","H_Bandanna_camo","H_Bandanna_khk","H_Booniehat_oli","H_Cap_blk","H_Cap_blk_CMMG"];
_baseGlasses = [];

// Vests
_lightRig = ["V_Chestrig_blk","V_Chestrig_rgr"];
_standardRig = ["V_TacVest_camo","V_TacVest_oli","V_TacVest_khk","V_TacVest_blk"];
