...
_baseUniform = ["U_C_WorkerCoveralls","U_C_HunterBody_grn","U_C_Poloshirt_blue","U_C_Poloshirt_burgundy","U_C_Poloshirt_stripped","U_C_Poloshirt_tricolour","U_C_Poloshirt_salmon","U_C_Poloshirt_redwhite","U_NikosBody","U_OrestesBody","U_Rangemaster","U_C_Poor_1","U_C_Journalist","U_Marshal"];
_baseHelmet = [""];
_baseGlasses = [""];
...
// LOADOUT: RIFLEMAN
	case "r":
	{
		...
		_unit addBackpack (["B_FieldPack_blk","B_FieldPack_cbr","B_FieldPack_khk","B_FieldPack_oli","B_TacticalPack_rgr","B_TacticalPack_blk","B_TacticalPack_oli"] call BIS_fnc_selectRandom);
		(unitBackpack _unit) addMagazineCargoGlobal [_riflemag, 5];
		(unitBackpack _unit) addMagazineCargoGlobal [_riflemag_tr, 2];
        (unitBackpack _unit) addWeaponCargoGlobal [_rifle call BIS_fnc_selectRandom,1];
        (unitBackpack _unit) addItemCargoGlobal [_mediumRig call BIS_fnc_selectRandom,1];
	};
...
// LOADOUT: COMMANDER
	case "co":
	{
        ...
        (unitBackpack _unit) addWeaponCargoGlobal [_glrifle call BIS_fnc_selectRandom,1];
        (unitBackpack _unit) addItemCargoGlobal [_mediumRig call BIS_fnc_selectRandom,1];
        (unitBackpack _unit) addItemCargoGlobal [_nvg,1];
	};
...
// LOADOUT: MEDIC
	case "m":
	{
        ...
        (unitBackpack _unit) addWeaponCargoGlobal [_pistol,1];
