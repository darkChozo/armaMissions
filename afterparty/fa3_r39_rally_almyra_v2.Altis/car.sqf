...
_car addAction ["Flip car",{
    _this select 0 setPosATL [getPosATL (_this select 0) select 0,getPosATL (_this select 0) select 1, (getPosATL (_this select 0) select 2) + 1];
    _this select 0 setVectorUp [0,0,1]
},nil,5.2,true,true,"","_this == _target getVariable 'driver'"];
