...
createMarkerLocal ["city",position cityTrigger];
"city" setMarkerShapeLocal "ELLIPSE";
"city" setMarkerBrushLocal "BORDER";
"city" setMarkerColorLocal "colorOPFOR";
"city" setMarkerSizeLocal (triggerArea cityTrigger select [0,2]);
"city" setMarkerDirLocal (triggerArea cityTrigger select 2);
createMarkerLocal ["cityText",position cityTrigger];
"cityText" setMarkerShapeLocal "ICON";
"cityText" setMarkerTypeLocal "mil_objective";
"cityText" setMarkerTextLocal "Yanukka";


createMarkerLocal ["airstrip",position airstripTrigger];
"airstrip" setMarkerShapeLocal "ELLIPSE";
"airstrip" setMarkerBrushLocal "BORDER";
"airstrip" setMarkerColorLocal "colorOPFOR";
"airstrip" setMarkerSizeLocal (triggerArea airstripTrigger select [0,2]);
"airstrip" setMarkerDirLocal (triggerArea airstripTrigger select 2);
createMarkerLocal ["airstripText",position airstripTrigger];
"airstripText" setMarkerShapeLocal "ICON";
"airstripText" setMarkerTypeLocal "mil_objective";
"airstripText" setMarkerTextLocal "Airstrip";
