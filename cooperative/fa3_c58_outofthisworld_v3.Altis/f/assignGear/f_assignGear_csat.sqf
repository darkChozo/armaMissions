...
_riflemag = "30Rnd_65x39_caseless_green_mag_Tracer";
_riflemag_tr = "30Rnd_65x39_caseless_green_mag_Tracer";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "arifle_Katiba_C_F";
_carbinemag = "30Rnd_65x39_caseless_green_mag_Tracer";
...
_glriflemag = "30Rnd_65x39_caseless_green_mag_Tracer";
...
// Automatic Rifleman
_AR = "LMG_Zafir_F";
_ARmag = "150Rnd_762x54_Box_Tracer";
...
_baseHelmet = ["H_CrewHelmetHeli_B"];
_baseGlasses = [];
...
// LOADOUT: AIR VEHICLE PILOTS
	case "pp":
	{
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmag, 10];
		_unit addweapon _AR;
        _unit execVM "holoman.sqf";
	};
