...
_ps setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal", 16, 7, 48], "", "Billboard", 1, 16, _relPos, [0, 0, 0], 0, 10, 7.9, 0.066, [0, 20,25], [_colorArray + [1],_colorArray + [1],_colorArray + [1],_colorArray + [0],_colorArray + [0]], [0.05,0.1], 1, 0, "", "", _object];
