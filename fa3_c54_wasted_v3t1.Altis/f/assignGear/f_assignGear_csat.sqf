...
// Automatic Rifleman
_AR = "arifle_Mk20C_plain_F";
_ARmag = "30Rnd_556x45_Stanag";
_ARmag_tr = "30Rnd_556x45_Stanag";
...
_baseHelmet = ["H_RacingHelmet_1_F","H_RacingHelmet_2_F","H_RacingHelmet_3_F","H_RacingHelmet_4_F","H_RacingHelmet_1_black_F","H_RacingHelmet_1_blue_F","H_RacingHelmet_1_green_F","H_RacingHelmet_1_red_F","H_RacingHelmet_1_white_F","H_RacingHelmet_1_yellow_F","H_RacingHelmet_1_orange_F"];
_baseGlasses = [];
...
_mediumRig = ["V_BandollierB_khk","V_HarnessO_gry","V_HarnessOGL_gry","V_Chestrig_khk","V_TacVest_khk","V_TacVest_brn","V_TacVest_oli","V_TacVest_blk"]; 	// default for all infantry classes
_heavyRig = ["V_TacVest_khk","V_TacVest_brn","V_TacVest_oli","V_TacVest_blk"];

// Diver
_diverUniform =  [""];
_diverHelmet = _baseHelmet;
_diverRig = ["V_HarnessOGL_brn","V_HarnessOGL_gry"];
_diverGlasses = [];
...
// Spec Op
_sfuniform = ["U_C_Driver_4"];
_sfhelmet = ["H_RacingHelmet_4_F"];
_sfRig = ["V_PlateCarrierGL_blk"];
_sfGlasses = [];
...
// LOADOUT: COMMANDER
	case "co":
	{
		_unit addmagazines ["150Rnd_93x64_Mag",3];
		_unit addweapon "MMG_01_tan_F";					//_COrifle
...
// LOADOUT: RIFLEMAN
	case "r":
	{
        ...
        _unit selectWeapon "hgun_Rook40_F";
	};
...
// LOADOUT: GRENADIER
	case "gren":
	{
		_unit addmagazines [_grenade,8];		// Do not use with mgrenades
		//_unit addmagazines [_mgrenade,2];		// Do not use with grenades
        ...
        _unit addEventHandler ["Killed", {
            {
                if (_x == "HandGrenade") then {
                     _this select 0 removeMagazineGlobal "HandGrenade";
                     _this select 0 addMagazineGlobal "B_IR_Grenade";
                };
...
// LOADOUT: RIFLEMAN (AT)
	case "rat":
	{
		...
		(unitBackpack _unit) addMagazineCargoGlobal ["RPG32_HE_F", 4];
...
// LOADOUT: DESIGNATED MARKSMAN
	case "dm":
	{
		_unit addmagazines ["20Rnd_762x51_Mag",4];
