...
// Diver
_diverWep = _rifle;
_diverMag1 = _riflemag;
_diverMag2 = _riflemag_tr;
_diverMag3 = _riflemag;
...
_baseUniform = ["U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_3_F","U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F","U_I_C_Soldier_Para_4_F"];
_baseHelmet = [];
