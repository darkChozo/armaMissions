...
heli addEventhandler ["GetIn", {[_this,["I_C_Soldier_base_F"],false] call f_fnc_authorisedCrewCheck}];
...
{
	if (side _x == independent) then { _synUnits pushBack _x };
...
f_var_mapClickTeleport_Units = _synUnits;		// Restrict map click teleport to these units
