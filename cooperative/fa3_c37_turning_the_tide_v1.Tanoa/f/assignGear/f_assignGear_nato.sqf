...
// Default setup
_attachments = ["optic_Aco_smg"]; // The default attachment set for most units, overwritten in the individual unitType
...
_glmag = "1Rnd_Smoke_Grenade_shell";
...
_MMGmag_tr = "200Rnd_556x45_Box_Red_F";
...
_baseUniform = ["U_B_GEN_Commander_F"];
_baseHelmet = ["H_PilotHelmetHeli_B"];
_baseGlasses = ["","","","","G_Bandanna_blk","G_Bandanna_beast","G_Balaclava_blk"];

// Vests
_lightRig = ["V_PlateCarrier1_blk"];
_standardRig = ["V_PlateCarrier2_blk"];
...
// Ghillie
_ghillieUniform = ["U_B_GEN_Soldier_F"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Beret_gen_F"];
_ghillieRig = ["V_Chestrig_blk"];
_ghillieGlasses = ["G_Bandanna_shades","G_Bandanna_beast","G_Bandanna_sport","G_Bandanna_aviator"];
