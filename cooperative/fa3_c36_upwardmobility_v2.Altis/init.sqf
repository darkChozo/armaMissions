...
// OPFOR > CSAT
[OPFOR,100,{[4,false] call f_fnc_mpEnd}] execVM "f\casualtiesCap\f_CasualtiesCapCheck.sqf";
...
{_x execVM "cratetransport.sqf"} forEach [convoy_1,convoy_2,convoy_3];

if (!isServer) exitWith {};
_handle = [convoy,"c_wp",15] spawn ws_fnc_taskConvoy;
[] execVM "crateTracker.sqf";
waitUntil {scriptDone _handle};
sleep 30;
[] execVM "counterAttack.sqf";