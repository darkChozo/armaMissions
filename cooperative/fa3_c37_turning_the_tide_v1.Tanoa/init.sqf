...
if (isServer) then {
	...
	_mkr = createMarker ["village",position endTrigger];
	_mkr setMarkerShape "ELLIPSE";
	_mkr setMarkerColor "ColorRed";
	_mkr setMarkerSize [triggerArea endTrigger select 0,triggerArea endTrigger select 1];
	_mkr setMarkerDir (triggerArea endTrigger select 2);
