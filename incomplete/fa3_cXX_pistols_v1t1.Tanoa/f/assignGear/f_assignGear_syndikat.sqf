...
_baseHelmet = ["H_Bandanna_khk","H_Bandanna_cbr","H_Bandanna_surfer_blk","H_Beret_blk","H_Cap_blk","H_Cap_blk_CMMG","H_Cap_red","H_Cap_usblack"];
_baseGlasses = ["G_Bandanna_blk","G_Bandanna_beast","G_Bandanna_shades"];
