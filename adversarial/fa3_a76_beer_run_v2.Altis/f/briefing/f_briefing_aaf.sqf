...
<br/>
Bring as many <marker name='dropzone'>supplies</marker> as you can to our <marker name='aafdropoff'>drop off</marker>, or kill all the FIA.
<br/><br/>
Supplies are counted when all supplies have been collected or when one side is dead (the surviving side gets the remaining supplies). Whoever has the most supplies wins!
<br/><br/>
