...
if (_unitfaction in ["blu_f","blu_t_f","blu_ctrg_f"]) then {
	...
	["GrpNATO_A1",_tnk, "A1", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A2",_tnk, "A2", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A3",_tnk, "A3", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A4",_tnk, "A4", "ColorRed"] spawn f_fnc_localGroupMarker;

	["GrpNATO_B1",_tnk, "B1", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B2",_tnk, "B2", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B3",_tnk, "B3", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B4",_tnk, "B4", "ColorBlue"] spawn f_fnc_localGroupMarker;

	["GrpNATO_C1",_tnk, "C1", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C2",_tnk, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C3",_tnk, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C4",_tnk, "C4", "ColorGreen"] spawn f_fnc_localGroupMarker;
