...
<br/>
You should be able to communicate with NATO using CC. Feel free to coordinate your plans with them; just remember that they can't see side markers and Syndikat *can* see global markers.
<br/><br/>
...
2. Protect our CO as he meets with the NATO CO.<br/>
3. Once we've gotten the information we need, kill the NATO CO.<br/>
4. Escort our CO out of the area.
<br/><br/>
Syndikat assassins are attempting to kill the officers, and NATO may be planning to turn on us. Have fun!";
} else {
	_missionText = "
1. Escort our CO to the <marker name='meetingzone'>meeting area</marker>.<br/>
2. Protect our CO as he meets with the NATO CO.<br/>
...
if (EAST in doubleCrossSides) then {
	...
	_situationAdendum = "This could be huge for our efforts on Tanoa. Ensure that meeting goes on as planned and that our officer survives. That is, assuming NATO doesn't pull a fast one on us...";
};
